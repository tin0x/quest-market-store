  ...
  return (
    <section>
      <Container className="flex flex-col gap-10">
        <h2 className="text-center text-[40px] font-bold lg:text-[60px]">What We Offer</h2>
        <div className="flex flex-col gap-20">
          <div
            className="relative overflow-hidden rounded-md bg-cover bg-no-repeat lg:h-125 lg:px-20 lg:py-32.5"
          ...
          >
            ...
            <div className="relative z-10 flex h-full flex-col justify-center p-8">
              <HeadingDescription
                className="w-full text-justify md:w-1/2 md:text-left"
                classTitle="text-center sm:text-left"
          ...
          >
            ...
            <div className="relative z-10 flex h-full flex-col items-end justify-center p-8">
              <HeadingDescription
                className="w-full text-justify md:w-1/2 md:text-right"
                classTitle="text-center sm:text-right"
