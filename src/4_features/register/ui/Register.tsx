...
import { type RegisterForm, RegisterSchema } from '@features/register/schemas/RegisterSchema.ts';
import { zodResolver } from '@hookform/resolvers/zod';
import { cn } from '@shared/lib/utils/cn.ts';
import { useRegister } from '@features/register/model/useRegister.ts';
